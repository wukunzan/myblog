...
<head>
    ...
    <title>@yield('title', '吴坤赞博客') </title>
    <meta name="description" content="@yield('description', setting('seo_description', '吴坤赞'))" />
    <meta name="keyword" content="@yield('keyword', setting('seo_keyword', 'wukunzan,blog,吴坤赞'))" />
